...
class FileMoverApp:
    ...
    def move_files(self):
        ...
        for _, row in df.iterrows():
            ...
            # Voeg de mapnaam en prefix toe aan het pad
            destination_path = os.path.join(destination_path, folder_name + "_" + file_prefix)
            ...
            for filename in os.listdir(source_folder):
                ...
                destination_file = os.path.join(destination_path, file_prefix + "_" + "_".join(file_name_parts) + os.path.splitext(filename)[1])
