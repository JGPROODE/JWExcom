...
class FileMoverApp:
    def __init__(self, root, initial_csv_path=None, initial_source_folder=None):
        ...
        tk.Label(root, text="Pad naar CSV-bestand:", bg=APP_BACKGROUND_COLOR).grid(row=0, column=0, padx=10, pady=10)
        ...
        tk.Label(root, text="Pad naar bronmap:", bg=APP_BACKGROUND_COLOR).grid(row=1, column=0, padx=10, pady=10)
        ...
        self.csv_button.grid(row=2, column=1, pady=10)
        ...
        tk.Label(root, text="Selecteer kolommen voor het pad:", bg=APP_BACKGROUND_COLOR).grid(row=3, column=0, padx=10, pady=10)
        self.path_listbox = self.create_listbox_with_buttons(root, 4, 0)

        tk.Label(root, text="Selecteer kolommen voor de studentmap:", bg=APP_BACKGROUND_COLOR).grid(row=3, column=1, padx=10, pady=10)
        self.name_listbox = self.create_listbox_with_buttons(root, 4, 1)

        tk.Label(root, text="Selecteer kolommen voor de prefix van de bestanden:", bg=APP_BACKGROUND_COLOR).grid(row=3, column=2, padx=10, pady=10)
